...
class Dashboard(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.protiens_target = self.get_max_nutritional_contents()['protein_grams']
        ...
        self.carbs_target = self.get_max_nutritional_contents()['carbs_grams']
        ...
        self.fats_target = self.get_max_nutritional_contents()['fats_grams'] 
        self.fats_consumed = self.today_nutrition_values["Total_Fats"]
        self.fats_percent = self.fats_consumed/self.fats_target

        self.fiber_target =self.get_max_nutritional_contents()['fiber_grams']
        ...
        # create third frame
        # self.third_frame = yoga.YogaScrollableFrame(master=self, width=1200, height=700).mainloop()
